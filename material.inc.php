...
$this->discoveryTiles = array(
    0 => array("id" => 0, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(1 Copy)"), "price" => array("cocoa" => 2, "wood" => 0, "gold" => 1), "bonus" => array("mask" => 1, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    1 => array("id" => 1, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(2 Copies)"), "price" => array("cocoa" => 1, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 2, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    2 => array("id" => 2, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(2 Copies)"), "price" => array("cocoa" => 1, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 2, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    3 => array("id" => 3, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(2 Copies)"), "price" => array("cocoa" => 1, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 3, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    4 => array("id" => 4, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(2 Copies)"), "price" => array("cocoa" => 1, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 3, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    5 => array("id" => 5, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 4, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    6 => array("id" => 6, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 4, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    7 => array("id" => 7, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 4, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    8 => array("id" => 8, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 5, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    9 => array("id" => 9, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 5, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    10 => array("id" => 10, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 5, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    11 => array("id" => 11, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 6, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    12 => array("id" => 12, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 6, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    13 => array("id" => 13, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 6, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    14 => array("id" => 14, "tooltip" => clienttranslate("These are masks, used to score during Eclipse. The small number in the bottom right corner shows how many copies of that mask exist. Lower numbered masks are less common, which makes them more valuable.<br>(3 Copies)"), "price" => array("cocoa" => 0, "wood" => 1, "gold" => 0), "bonus" => array("mask" => 7, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 0, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
