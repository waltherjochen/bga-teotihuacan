...
$this->discoveryTiles = array(
    ...
    42 => array("id" => 42, "tooltip" => clienttranslate("Price: {cocoa}{wood}{gold}<br><br>Use when moving a worker to move a second worker from the same Action Board to the same Action Board"), "price" => array("cocoa" => 0, "wood" => 0, "gold" => 0), "bonus" => array("mask" => 0, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 1, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    43 => array("id" => 43, "tooltip" => clienttranslate("Price: {cocoa}{wood}{gold}<br><br>Use when moving a worker to move a second worker from the same Action Board to the same Action Board"), "price" => array("cocoa" => 0, "wood" => 0, "gold" => 0), "bonus" => array("mask" => 0, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 1, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
    44 => array("id" => 44, "tooltip" => clienttranslate("Price: {cocoa}{wood}{gold}<br><br>Use when moving a worker to move a second worker from the same Action Board to the same Action Board"), "price" => array("cocoa" => 0, "wood" => 0, "gold" => 0), "bonus" => array("mask" => 0, "vp" => 0, "r" => 0, "ad" => 0, "temple_choose" => 0, "temple_blue" => 0, "temple_red" => 0, "temple_green" => 0, "cocoa" => 0, "upgrade" => 0, "move_double" => 1, "free_cocoa" => 0, "move_choose" => 0, "extra_worker" => 0)),
